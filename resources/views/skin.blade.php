   @extends('layout')
    ...
    <main>
              ...
              @foreach($products as $product)
                    ...
                    <div class="small-img-container">
                            <div class="small-img-col">
                                <img src="./assets/productshowcase/skin1.jpg" alt="" srcset=""class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="./assets/productshowcase/skin2.jpg" alt="" srcset="" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="./assets/productshowcase/skin3.jpg" alt="" srcset="" class="small-img"> 
                            </div>
                            <div class="small-img-col">
                                <img src="./assets/productshowcase/skin4.jpg" alt="" srcset="" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="./assets/productshowcase/skin5.jpg" alt="" srcset="" class="small-img">
                            </div>
                        </div>
        ...
        <div class="middle-image">
            <img src="./assets/productshowcase/skin-middle-img.jpg" alt="">
        </div>
        <!-- middleimage--------------------------------------------> 
        <!-- ingredients-display--------------------------------------------> 
        ...
        <div class="reserch">
            <div class="container">
                <div class="right-img">
                    <img src="./assets/productshowcase/skin-last-img.jpg" alt="">
                </div>
                <div class="left-text">

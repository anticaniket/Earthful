    ...
    <main>
              ...
              @foreach($products as $product)
                    ...
                    <div class="small-img-container">
                            <div class="small-img-col">
                                <img src="./assets/productshowcase/hair1.jpg" alt="" srcset=""class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="./assets/productshowcase/hair2.jpg" alt="" srcset="" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="./assets/productshowcase/hair3.jpg" alt="" srcset="" class="small-img"> 
                            </div>
                            <div class="small-img-col">
                                <img src="./assets/productshowcase/hair4.jpg" alt="" srcset="" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="./assets/productshowcase/hair5.jpg" alt="" srcset="" class="small-img">
                            </div>
                        </div>
        ...
        <div class="middle-image">
            <img src="./assets/productshowcase/hair-middle-img.jpg" alt="">
        </div>
        <!-- middleimage--------------------------------------------> 
        <!-- ingredients-display--------------------------------------------> 
        ...
        <div class="reserch">
            <div class="container">
                <div class="right-img">
                    <img src="./assets/productshowcase/hair-last-img.jpg" alt="">
                </div>
                <div class="left-text">

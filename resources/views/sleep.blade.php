    ...
    <main>
        ...
        <div class="middle-image">
            <img src="./assets/productshowcase/sleep-middle-img.jpg" alt="">
        </div>
        <!-- middleimage--------------------------------------------> 
        <!-- ingredients-display--------------------------------------------> 
        ...
        <div class="reserch">
            <div class="container">
                <div class="right-img">
                    <img src="./assets/productshowcase/sleep-last-img.jpg" alt="">
                </div>
                <div class="left-text" style="background:#96B5B8;">
                    <h1>Why Earthful's <br> Plant Protein is <br> LOVED? <br> <div style="font-weight:200;">|</div></h1>
                    <ul>

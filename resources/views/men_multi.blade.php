@extends('layout')
    @section('title','Men Multivitamin18')
    @section('content')
    <main>
        <!-- productinfo-------------------------------------- -->
        @if(session('success'))
                    ...
                    <div class="product-div-left">
                        <div class="small-img-container">
                                <div class="small-img-col">
                                    <img src="./assets/productshowcase/men-multi1.jpg" alt="" srcset=""class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="./assets/productshowcase/men-multi2.jpg" alt="" srcset="" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="./assets/productshowcase/men-multi4.jpg" alt="" srcset="" class="small-img"> 
                                </div>
                                <div class="small-img-col">
                                    <img src="./assets/productshowcase/men-multi5.jpg" alt="" srcset="" class="small-img">
                                </div>
                                <div class="small-img-col">
                                    <img src="./assets/productshowcase/men-multi6.jpg" alt="" srcset="" class="small-img">
                                </div>
                        </div>
        ...
        <div class="middle-image">
            <img src="./assets/productshowcase/men-multi-middle-img.jpg" alt="">
        </div>
        <!-- middleimage--------------------------------------------> 
        <!-- ingredients-display--------------------------------------------> 
        ...
        <div class="reserch">
            <div class="container">
                <div class="right-img">
                    <img src="./assets/productshowcase/men-multi-last-img.jpg" alt="">
                </div>
                <div class="left-text" style=background:#FFF1BD;>
